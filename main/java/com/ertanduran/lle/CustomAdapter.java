...
/**
 * Created by ertandrn on 27.02.2018.
 */
...
public class CustomAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (firebaseUser.getEmail().equalsIgnoreCase(message.getGonderici())){
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.bizim, parent, false);
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.diger, parent, false);
